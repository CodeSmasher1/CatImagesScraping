...
PATH = "D:\\Image-Scraper-And-Downloader-main\\chromedriver.exe"
...
urls = get_images_from_google(wd, 1, 11)

for i, url in enumerate(urls):
	download_image("D:\Image-Scraper-And-Downloader-main\Images", url, str(i) + ".jpg")
